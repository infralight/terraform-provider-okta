...
- `custom_endpoint` - (Optional) This is a custom URL endpoint that can be used for unit testing or local caching proxies. Can also be sourced from the `OKTA_CUSTOM_ENDPOINT` environment variable.
